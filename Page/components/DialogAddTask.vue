...
> <i class="el-icon-tickets" /> <span style="line-height:32px;">临时任务类型</span> </el-col>
			<el-col :span="6"> <el-input size="small" style="width:180px;" 
placeholder="自定义临时任务类型" v-model="input10" clearable
/> </el-col>
		</el-row>
		<div class="line" />
		<el-row :gutter="40">
			<el-col :span="10"> <el-input size="small" style="width:400px;" 
placeholder="自定义临时任务类型" v-model="input10" suffix-icon="el-icon-search"
/> </el-col>
      <el-col :span="8">
        <span style="color:#939393">任务时限:</span>
				<el-select v-model="timeLimitValue" size="small" placeholder="请选择"> <el-option v-for="item in timeLimitOpts" :key="item.value" 
:label="item.label" :value="item.value"
/> </el-select>
			</el-col>
		</el-row>
		<el-table ref="multipleTable" :data="flights" 
show-overflow-tooltip="true" height="250" highlight-current-row style="width: 100%" @selection-change="handleSelectionChange" @row-click="handleRowClick"
>
...
>
			<el-button type="primary" @click="dialogAddTaskVisible = false;"
>提交</el-button>
