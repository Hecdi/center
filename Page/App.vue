    ...
    <el-container>
      <el-header height="50px;">
        <div id="nav" class="top-menu navbar navbar-dark bg-inverse">
          ...
          <span class="navbar-departName">机坪摆渡电气空调</span>
          <ul class="nav navbar-nav">
            <router-link tag="li" to="/" class="nav-item" exact>排班</router-link>
            <router-link tag="li" to="/checkIn" class="nav-item">点到</router-link>
