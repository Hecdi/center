			...
			<el-col :span="22" class="task">
				<el-row :gutter="20">
					<el-col :span="8" style="position:relative;" >
						<el-collapse v-model="activeTask" v-for="mainTask in item.taskList0" :key="mainTask.mainTaskId">
					...
					<el-col :span="8" style="position:relative;" >
						<el-collapse v-model="activeTask" v-for="mainTask in item.taskList1" :key="mainTask.mainTaskId">
							<el-collapse-item :name="mainTask.mainTaskId" :class="`bgh${mainTask.mainTaskStatus}`">
								<template slot="title" calss="aaa" style="background-color: green;">
									<el-row :gutter="2" class="mainTaskPanel">
										<el-col class="taskNumPanel" :span="3">{{ mainTask.taskNumber }}</el-col>
					...
					<el-col :span="8" style="position:relative;" >
						<el-collapse v-model="activeTask" v-for="mainTask in item.taskList2" :key="mainTask.mainTaskId">
							<el-collapse-item :name="mainTask.mainTaskId" :class="`bgh${mainTask.mainTaskStatus}`">
								<template slot="title" calss="aaa" style="background-color: green;">
									<el-row :gutter="2" class="mainTaskPanel">
										<el-col class="taskNumPanel" :span="3">{{ mainTask.taskNumber }}</el-col>
