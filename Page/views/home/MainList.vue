<template>
  <div class="mainList">
    <el-row :gutter="20" v-for="item in mainList" v-bind:key="item.areaName" >
					...
					<el-card shadow="always" :v-id="task.taskId" @click.native="showDeatil(task.taskId)"> 
						...
						<el-aside width="95%">
							<el-row :gutter="10" class="first-row">
								<el-col :span="20">
								<i class="el-icon-edit"></i>{{ task.seat }} 
								<i class="el-icon-edit"></i>{{ task.gate}} 
								<i class="el-icon-edit"></i>{{ task.aircraftType }} 
								</el-col>
								<el-col :span="4">
								</el-col>
							</el-row>
