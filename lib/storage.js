...
// homeTableDB.find({searchKey:'查询语句'}).sort({sortKey:"排序关键字"}).skip(currentPage * pageSize).limit(pageSize);
  
// console.log(results);
// export const saveHomeTableDB = (data, currentPage, pageSize) => {
	
// 	homeTableDB.insert(process(cloneDeep(data)));
// 	// var dv = homeTableDB.addDynamicView('myview');
// 	// var tx = [
// 	//   {
// 	//     type: 'offset',
...
// 	//   }
// 	// ];
// 	// homeTableDB.addTransform('viewPaging', tx);
// 	// // add some records
// 	// var results = dv.branchResultset('viewPaging', { pageStart: 10, pageSize: 15});  
// 	// return Promise.resolve(homeTableDB.find({ pageStart: 10, pageSize: 16 }));
// 	// return Promise.resolve(homeTableDB.find().skip(10).limit(10));
// 	// var tx = [
// 	// 	{
// 	// 	  type: 'offset',
// 	// 	  value: '[%lktxp]pageStart'
...
// 	// 	}
// 	//   ];
// 	var resultset=homeTableDB.chain().find();
// 	// let tiaojian = homeTableDB.find();
// 	return Promise.resolve(resultset.offset(currentPage).limit(pageSize).data());
// };
