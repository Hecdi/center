...
export var taskDB = DB.addCollection('task', {
	unique: ['taskId'],
	indices: ['areaName','airRoute','aircraftType','flightStatus','flightIndicator','taskStatus', 'movement', 'aircraftNumber', 'airRoute','flightNo','correlationFlightNo','seat','gate','taskBindingShiftName'],
});
...
export const saveHomeTableDB = (data) => {
	homeTableDB.insert(cloneDeep(data));
