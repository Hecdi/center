...
export var taskDB = DB.addCollection('task', {
	unique: ['taskId'],
	indices: ['areaName','airRoute','aircraftType','flightStatus','flightId','flightIndicator','taskStatus', 'movement','taskBindingShiftNames', 'aircraftNumber', 'airRoute','flightNo','correlationFlightNo','seat','gate','taskBindingShiftName'],
});
